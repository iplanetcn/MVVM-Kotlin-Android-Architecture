...
class ProductsActivityTest {
    @get:Rule
    var mActivityTestRule = ActivityTestRule(ProductsActivity::class.java)
    ...
    fun testRefresh() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.rv_product_list)).check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
